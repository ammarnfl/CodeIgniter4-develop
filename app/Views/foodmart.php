...
<table>
    ...
    <tr>
        <td> 
            <?= esc($foodmart_item['the_day']) ?>,
            <?= esc($foodmart_item['day_of_month']) ?>
            <?= esc($foodmart_item['the_month']) ?>
            <?= esc($foodmart_item['the_year']) ?> 
        </td>
        <td> 
            (<?= esc($foodmart_item['account_num']) ?>)
            <?= esc($foodmart_item['fullname']) ?> 
        </td>
        <td> 
            <?= esc($foodmart_item['product_name']) ?>
            (<?= esc($foodmart_item['brand_name']) ?>) 
        </td>
    </tr>
<?php endforeach ?> 
</table>
